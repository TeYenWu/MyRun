...
//PhotoDialogFragment handles all the customized dialog boxes in our project.
...
public class PhotoDialogFragment extends DialogFragment {
	...
	public interface OnPhotoDialogFragmentListener {
		void onPhotoPickerItemSelected(int item);
	}
	// Different dialog IDs
	public static final int DIALOG_ID_ERROR = -1;
	public static final int DIALOG_ID_PHOTO_PICKER = 1;
	OnPhotoDialogFragmentListener mListener;
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		if (parent instanceof OnPhotoDialogFragmentListener) {
			mListener = (OnPhotoDialogFragmentListener) parent;
		}
		...
		case DIALOG_ID_PHOTO_PICKER:
			...
			DialogInterface.OnClickListener dlistener = new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int item) {
					...
					mListener.onPhotoPickerItemSelected(item);
				}
			};
