...
import com.teyenwu.myrun.ui.main.PhotoDialogFragment;
...
public class UserProfileActivity extends AppCompatActivity implements PhotoDialogFragment.OnPhotoDialogFragmentListener {
    private static final int  MY_PERMISSIONS_REQUEST_CAMERA = 0;
    private static final String URI_INSTANCE_STATE_KEY = "saved_uri";


    private static final int  REQUEST_IMAGE_CAPTURE = 3;
    private static final int  REQUEST_IMAGE_PICKER = 4;
    ...
    private void launchGallery(){
        ...
        if (pickPictureIntent.resolveActivity(getPackageManager()) != null) {
            ContentValues values = new ContentValues(1);
            values.put(MediaStore.Images.Media.MIME_TYPE, "image/jpg");
            this.startActivityForResult(pickPictureIntent, REQUEST_IMAGE_PICKER);
        }
    }
    ...
    public void changeProfile(){
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED
            ...
            DialogFragment fragment = PhotoDialogFragment.newInstance(PhotoDialogFragment.DIALOG_ID_PHOTO_PICKER);
            fragment.show(this.getSupportFragmentManager(), "dialog_fragment_photo_picker");
        }
    }
